...
function calc(){
    ...
    function getStatickInform(selector, activeClass){
        const elements = document.querySelectorAll(selector);
    ...
    getStatickInform('#gender div', 'calculating__choose-item_active');
    getStatickInform('.calculating__choose_big div', 'calculating__choose-item_active');
